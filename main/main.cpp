...
void testTask4(void *pvParameters) {
    ...
    while (1)
    {
        ret = icm20948.connective();

        if (ret) ESP_LOGI("Test4", "Successfully connect ICM20948 !");
        else ESP_LOGW("Test4", "Fail to connect ICM20948 !");
...
extern "C" void app_main(void) {
    ...
    if (!mpu9250.init()) {
        ESP_LOGW("main", "Fail to connect mpu !");
    }
